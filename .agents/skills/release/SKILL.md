...
name: release
description: >
  Coordinate a full Ciutatis release across engineering verification, npm,
...
Run the full Ciutatis maintainer release workflow, not just an npm publish.
...
7. If running through Ciutatis, you have issue context for status updates and follow-up task creation.
...
Ciutatis now uses a commit-driven release model:
...
- release summary in Ciutatis issue context
