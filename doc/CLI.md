...
Ciutatis CLI now supports both:
...
`agent local-cli` is the quickest way to run local Claude/Codex manually as a Ciutatis agent:

- creates a new long-lived agent API key
- installs missing Ciutatis skills into `~/.codex/skills` and `~/.claude/skills`
