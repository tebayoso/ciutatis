...
Low-level reference for how Ciutatis packages are prepared and published to npm.
...
Ciutatis no longer uses release branches or Changesets for publishing.
...
Ciutatis uses calendar versions:
