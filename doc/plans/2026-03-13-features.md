...
- Team of 3 can use one shared Ciutatis instance.
...
Ciutatis should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
- A chat plugin can converse without requiring chat to become the core Ciutatis product.
...
- **Keep** Ciutatis as the board-level control plane.
