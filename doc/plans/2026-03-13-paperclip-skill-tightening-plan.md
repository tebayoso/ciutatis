# Ciutatis Skill Tightening Plan
...
- preserve all current Ciutatis control-plane capabilities
...
- changing Ciutatis API semantics
...
- add at least lightweight eval or scripted scenario coverage for key Ciutatis flows
- confirm how adapter/bootstrap layering should load skill content versus references

## Success Criteria

- materially lower first-run input tokens for Ciutatis-coordinated agents
