...
- Running a Python script that calls the Ciutatis API
...
1. Ciutatis spawns the configured command as a child process
2. Standard Ciutatis environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Ciutatis API and perform work.
