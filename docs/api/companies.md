...
Manage companies within your Ciutatis instance.
...
Company logo uploads use the normal Ciutatis attachment size limit.
...
| `logoUrl` | string | Optional Ciutatis asset content path for the stored logo image |
