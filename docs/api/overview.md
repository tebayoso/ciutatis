...
Ciutatis exposes a RESTful JSON API for all control plane operations.
...
- Run audit trail: include `X-Ciutatis-Run-Id` header on all mutating requests during heartbeats
