...
summary: Run Ciutatis with Tailscale-friendly host binding and connect from other devices
---

Use this when you want to access Ciutatis over Tailscale (or a private LAN/VPN) instead of only `localhost`.

## 1. Start Ciutatis in private authenticated mode
...
From the machine running Ciutatis:
...
## 3. Open Ciutatis from another device

Use the Tailscale IP or MagicDNS host with the Ciutatis port:
