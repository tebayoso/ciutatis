...
import { institutionSecrets } from "./institution_secrets.js";

export const institutionSecretVersions = sqliteTable(
  "company_secret_versions",
  {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    secretId: text("secret_id").notNull().references(() => institutionSecrets.id, { onDelete: "cascade" }),
...
export const companySecretVersions = institutionSecretVersions;
