...
export const requests = pgTable(
  "issues",
  {
    ...
    goalId: uuid("goal_id").references(() => objectives.id),
    parentId: uuid("parent_id").references((): AnyPgColumn => requests.id),
    ...
    // Upstream-only columns for compatibility (not used in Ciutatis V1)
    ...
    monitorAttemptCount: integer("monitor_attempt_count"),
