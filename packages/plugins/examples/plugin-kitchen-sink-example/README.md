...
Kitchen Sink is the first-party reference plugin that demonstrates nearly the full currently implemented Ciutatis plugin surface in one package.
...
Or install it from the Ciutatis plugin manager as a bundled example once this repo is built.
...
- Some SDK-defined host surfaces still depend on the Ciutatis host wiring them visibly; this package aims to exercise the currently mounted ones and make the rest obvious.
