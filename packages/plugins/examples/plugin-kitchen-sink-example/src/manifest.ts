...
const manifest: CiutatisPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Ciutatis plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Ciutatis",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Ciutatis domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
