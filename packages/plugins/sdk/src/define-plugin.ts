/**
 * `definePlugin` — the top-level helper for authoring a Ciutatis plugin.
 *
 ...
 * ```ts
 * // dist/worker.ts
 * import { definePlugin } from "@ciutatis/plugin-sdk";
 *
...
// ---------------------------------------------------------------------------
// CiutatisPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface CiutatisPlugin {
 ...
 * @returns A sealed `CiutatisPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@ciutatis/plugin-sdk";
