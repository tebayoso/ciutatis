 ...
 *
 * These components are exported from `@ciutatis/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@ciutatis/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function CiutatisSdkUiComponent(props: TProps) {
