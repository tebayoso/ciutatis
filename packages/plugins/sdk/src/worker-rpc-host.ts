 ...
 * import { startWorkerRpcHost } from "@ciutatis/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@ciutatis/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
