...
import { execute } from "@ciutatis/adapter-gemini-local/server";
...
describe("gemini execute", () => {
  it("passes prompt as final argument and injects paperclip env vars", async () => {
    ...
    try {
      ...
      expect(capture.argv.at(-1)).toContain("Ciutatis runtime note:");
      ...
      expect(invocationPrompt).toContain("Ciutatis API access note:");
