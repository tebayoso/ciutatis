...
import type { WorkspaceOperation } from "@ciutatis/shared";
...
async function createTempRepo() {
  ...
  await runGit(repoRoot, ["config", "user.name", "Ciutatis Test"]);
...
describe("ensureRuntimeServicesForRun", () => {
  ...
  it("does not leak parent Ciutatis instance env into runtime service commands", async () => {
