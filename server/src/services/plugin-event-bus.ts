/**
 * PluginEventBus — typed in-process event bus for the Ciutatis plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@ciutatis/shared";
import type { PluginEvent, EventFilter } from "@ciutatis/plugin-sdk";
