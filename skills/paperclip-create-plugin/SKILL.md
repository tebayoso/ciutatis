...
# Create a Ciutatis Plugin

Use this skill when the task is to create, scaffold, or document a Ciutatis plugin.
...
- is installed into Ciutatis from an absolute local path during development
