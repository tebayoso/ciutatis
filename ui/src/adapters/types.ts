...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@ciutatis/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@ciutatis/adapter-utils").TranscriptEntry[];
