 ...
 *
 * Plugin bundles are built with `external: ["@ciutatis/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@ciutatis/plugin-sdk/ui";
 ...
 * - `import { ... } from "@ciutatis/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@ciutatis/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@ciutatis/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@ciutatis/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@ciutatis/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@ciutatis/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
